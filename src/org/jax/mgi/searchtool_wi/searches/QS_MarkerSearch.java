  ...
  */
    ...
    throws Exception
  {
    ...
    if (searchInput.hasFormParameter("incOnly") ) {
        String incItem = searchInput.getParameter("incOnly").toLowerCase();
